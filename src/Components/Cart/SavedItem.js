              ...
              {props.data.discount > 0 ? (
                  <h3>
                    ...
                    <span className="product-price-after-discount">
                      ...
                      new Intl.NumberFormat('en-US', {style: 'currency', currency:'VND'}).format( props.data.price -  (props.data.price * props.data.discount / 100)
                      )
                    ...
                    <span className="product-price-before-discount">
                      ...
                      {
                      /* R{props.data.price} */
                      new Intl.NumberFormat('en-US', {style: 'currency', currency:'VND'}).format(  props.data.price) 
                      }
